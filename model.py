...
class Transformer(nn.Module):
    ...
    def estimate_mfu(self, fwdbwd_per_iter, dt):
        """ estimate model flops utilization (MFU) in units of PVC1100 bfloat16 peak FLOPS """
        ...
        # express our flops throughput as ratio of PVC1100 bfloat16 peak flops
        flops_achieved = flops_per_iter * (1.0/dt) # per second
        flops_promised = 352e12 # PVC 1100 GPU bfloat16 peak flops is 352 TFLOPS (312 TFLOP for A100)
...
07:56:03 orange@hackathon llama2.c ±|
